...
const AllAds = ({ user }) => {
    ...
    const [reportDescription, setReportDescription] = useState('');  // 🔥 NEW: Description field
    ...
    const submitReport = useCallback(async () => {
        ...
        try {
            ...
            await axios.post(`${API_BASE_URL}/reports`, {
                adId: selectedAd._id,
                sellerId: selectedAd.posted_by_uid,  // Backend will convert to reportedUserId
                reason: reportReason,
                description: reportDescription  // 🔥 NEW: Required field
            }, {
...
export default AllAds;import React, { useState, useEffect, useCallback, useRef } from "react";
import axios from "axios";
import { useNavigate, useLocation, useSearchParams } from "react-router-dom";
import { 
    FaSearch, FaStar, FaMapMarkerAlt, FaPhoneAlt, FaUserCircle, 
